            ...
            @endif
              ...
              @foreach($essay as $data)
                ...
                <div class="form-group">
                  ...
                  @php
                    $answer = \App\Models\UserAnswer::where('user_id', Auth::id())->where('essay_question_id', $data->id)->first();  
                  @endphp
                  <textarea type="text" name="jawaban[]" id="jawaban{{ $data->id }}" class="form-control" style="height: 200px;">{{$answer->answer ?? ''}}</textarea>
