          ...
          <div class="row mb-1">
            <div class="col-md-12">
              @php
                ...
                $score = \App\Models\TotalScore::where('user_id', $user_id)->where('question_id', $q->id)->first();
                if($score !== null){
                  $final = $score->score;
                } else{
                  $wondering = \App\Models\WonderingScore::where(["user_id" => $user_id])->where('content_id', $c->id)->sum("score");
                  $exploring = \App\Models\UserScore::where("user_id", $user_id)->where('question_id', $q->id)->sum("score");
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      @php
                        $err = \App\Models\ExerciseCodeLog::where(['user_id' => $user_id, 'question_id' => $sc->question_id, 'is_error' => 1]);
                        $sucess = \App\Models\ExerciseCodeLog::where(['user_id' => $user_id, 'question_id' => $sc->question_id, 'is_error' => 0]);
                      @endphp
                    ...
                    <div class="col-md-3 " style="text-align:center">
                      <a href="{{ route('admin.dashboard.penilaian', ['user_id' => $user_id, 'content_id' => $sc->content_id]) }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">
